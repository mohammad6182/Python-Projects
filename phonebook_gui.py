...
def load_gui(self):
    ...
    self.lbl_lname = tk.Lable1(self.master, text ="Last Name: ")
    self.lbl_lname.grid( row = 2, column = 0, padx = (27,0) ,pady = (10,0), sticky=N+W)
    self.lbl_phone = tk.Lable1(self.master, text ="Phone Number: ")
    self.lbl_phone.grid( row = 4, column = 0, padx = (27,0) ,pady = (10,0), sticky=N+W)
    self.lbl_email = tk.Lable1(self.master, text ="Email Address: ")
    self.lbl_email.grid( row = 6, column = 0, padx = (27,0) ,pady = (10,0), sticky=N+W)
    self.lbl_user = tk.Lable1(self.master, text ="User: ")
    ...
    self.scrollbar.grid(row = 1, column = 2, rowspan = 7, columnspan = 3, padx = (0,0),pady = (0,0), sticky = N + E + S)
    self.lstList1.grid(row = 1, column = 2, rowspan = 7, column = 3, padx = (0,0), pady = (0,0), sticky = N + E + S + W)
